...
CREATE TABLE `table_company_data` (
  ...
  `company_name` varchar(266) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `table_company_data`
--

LOCK TABLES `table_company_data` WRITE;
/*!40000 ALTER TABLE `table_company_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `table_company_data` ENABLE KEYS */;
UNLOCK TABLES;
