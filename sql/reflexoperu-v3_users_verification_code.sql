...
--
-- Dumping data for table `users_verification_code`
--

LOCK TABLES `users_verification_code` WRITE;
/*!40000 ALTER TABLE `users_verification_code` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_verification_code` ENABLE KEYS */;
UNLOCK TABLES;
