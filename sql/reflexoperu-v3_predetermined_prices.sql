...
--
-- Dumping data for table `predetermined_prices`
--

LOCK TABLES `predetermined_prices` WRITE;
/*!40000 ALTER TABLE `predetermined_prices` DISABLE KEYS */;
/*!40000 ALTER TABLE `predetermined_prices` ENABLE KEYS */;
UNLOCK TABLES;
