...
class MedicalRecordService:
    ...
    def get_medical_record_by_id(record_id):
        ...
        try:
            ...
            return {
                ...
                'diagnose_name': record.diagnose.name,
                'diagnose_code': record.diagnose.code,
                'diagnose_id': record.diagnose.id,
    ...
    def create_medical_record(record_data):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                # Devolver datos con nombres completos
                return {
                    'id': record.id,
                    'patient_name': record.patient.get_full_name(),
                    'patient_id': record.patient.id,
            ...
            return None, {'error': f'Error al crear el historial médico: {str(e)}'}
    ...
    def update_medical_record(record_id, record_data):
        ...
        try:
            ...
            return None, {'error': f'Error al actualizar el historial médico: {str(e)}'}
